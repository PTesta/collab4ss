...
data are manipulated. For example, consider downloading data from \href{the
ANES}{http://electionstudies.org} and \href{the United States
Census}{http://www.census.gov} and joining it into a single table for analysis
