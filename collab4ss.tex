...
%PFT: Here's my attempt to give a transition from Synch to Async Collab with a drop box intro that leads into your discussion of its limitations.
...
synched with a user's other online account and other computurers, ensuring that
...
customers). DropBox is well suited for the less techinically savvy social 
